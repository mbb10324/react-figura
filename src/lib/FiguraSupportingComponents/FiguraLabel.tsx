...
export default function FiguraLabel(props: LabelProps) {
...
FiguraLabel.displayName = "FiguraLabel"; //we do this because children.name is unstable. Therefore we explicitly define a displayName