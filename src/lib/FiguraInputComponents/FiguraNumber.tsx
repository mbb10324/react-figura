...
export default function FiguraNumber(props: InputProps) {
                    ...
                    return (
                        <div className={`${wrapper ? wrapper : "input-container"}`}>
                            ...
                            <input
                                ...
                                onChange={e => { checkForErrors(false, name, e.target.value, "number", context.dispatch, context.formState, context.formID); }}
                                onBlur={e => { checkForErrors(true, name, e.target.value, "number", context.dispatch, context.formState, context.formID); }}
                            />
...
FiguraNumber.displayName = "FiguraNumber"; //we do this because children.name is unstable. Therefore we explicitly define a displayName