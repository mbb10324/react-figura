...
export default function FiguraWeek(props: Props) {
                    ...
                    return (
                        <div className={`${wrapper ? wrapper : "flex flex-col mb-1"}`}>
                            ...
                            <input
                                ...
                                onChange={e => { checkForErrors(false, fieldName, e.target.value, "week", context.dispatch, context.formState, context.formID, validator) }}
                                onBlur={e => { checkForErrors(true, fieldName, e.target.value, "week", context.dispatch, context.formState, context.formID, validator) }}
                            />
