...
export default function FiguraDate(props: InputShortProps) {
                    ...
                    return (
                        <div className={`${wrapper ? wrapper : "input-container"}`}>
                            ...
                            <input
                                ...
                                onChange={e => { checkForErrors(false, name, e.target.value, "date", context.dispatch, context.formState, context.formID); }}
                                onBlur={e => { checkForErrors(true, name, e.target.value, "date", context.dispatch, context.formState, context.formID); }}
                            />
...
FiguraDate.displayName = "FiguraDate"; //we do this because children.name is unstable. Therefore we explicitly define a displayName