...
export default function FiguraMonth(props: InputShortProps) {
                    ...
                    return (
                        <div className={`${wrapper ? wrapper : "input-container"}`}>
                            ...
                            <input
                                ...
                                onChange={e => { checkForErrors(false, name, e.target.value, "month", context.dispatch, context.formState, context.formID); }}
                                onBlur={e => { checkForErrors(true, name, e.target.value, "month", context.dispatch, context.formState, context.formID); }}
                            />
...
FiguraMonth.displayName = "FiguraMonth"; //we do this because children.name is unstable. Therefore we explicitly define a displayName