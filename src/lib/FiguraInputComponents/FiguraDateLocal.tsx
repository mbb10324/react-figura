...
export default function FiguraDateLocal(props: InputShortProps) {
                    ...
                    return (
                        <div className={`${wrapper ? wrapper : "input-container"}`}>
                            ...
                            <input
                                ...
                                onChange={e => { checkForErrors(false, name, e.target.value, "datelocal", context.dispatch, context.formState, context.formID); }}
                                onBlur={e => { checkForErrors(true, name, e.target.value, "datelocal", context.dispatch, context.formState, context.formID); }}
                            />
...
FiguraDateLocal.displayName = "FiguraDateLocal"; //we do this because children.name is unstable. Therefore we explicitly define a displayName