...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nvar react_1 = __importDefault(__webpack_require__(/*! react */ \"react\"));\n;\nfunction FiguraSubmitBtn(props) {\n    var children = props.children, wrapper = props.wrapper, buttonStyle = props.buttonStyle;\n    return (react_1.default.createElement(\"div\", { className: \"\".concat(wrapper ? wrapper : \"flex flex-col mb-1 mt-7\") },\n        react_1.default.createElement(\"button\", { className: \"\".concat(buttonStyle ? buttonStyle : \"border-2 border-sky-600 hover:border-2 hover:border-sky-400 hover:bg-sky-400 outline-none rounded-md p-2 transition-all duration-300 ease-in-out\"), type: \"submit\" }, children)));\n}\nexports[\"default\"] = FiguraSubmitBtn;\n;\n\n\n//# sourceURL=webpack://react-figura/./src/lib/FiguraSupportingComponents/FiguraSubmitBtn.tsx?");
